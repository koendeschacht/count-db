...
public class NewFileDataInterfaceFactory extends BaseDataInterfaceFactory {
    ...
    protected <T extends Object> BaseDataInterface<T> createBaseDataInterface(String name, Class<T> objectClass, Combinator<T> combinator, ObjectSerializer<T> objectSerializer, boolean isTemporaryDataInterface) {
        ...
        NewFileDataInterface<T> result = new NewFileDataInterface<>(memoryManager, combinator, objectClass, objectSerializer, directory, name, isTemporaryDataInterface, asyncJobService);
