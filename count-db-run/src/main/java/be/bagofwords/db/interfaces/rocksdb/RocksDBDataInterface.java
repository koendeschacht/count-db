...
public class RocksDBDataInterface<T> extends CoreDataInterface<T> {
    ...
    public RocksDBDataInterface(String name, Class<T> objectClass, Combinator<T> combinator, ObjectSerializer<T> objectSerializer, String directory, boolean usePatch, boolean isTemporaryDataInterface) {
